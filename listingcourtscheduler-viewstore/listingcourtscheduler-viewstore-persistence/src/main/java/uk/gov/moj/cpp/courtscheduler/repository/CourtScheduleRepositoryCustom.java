...
public interface CourtScheduleRepositoryCustom {
    ...
    /**
     * Was a JPQL {@code SELECT new ...CourtScheduleMatcherInfo(...)} constructor-expression
     * query on the main interface. Generated OpenAPI models have no positional constructor, so
     * this fetches the raw fields and builds the model via fluent setters instead.
     */
    CourtScheduleMatcherInfo findByCourtRoomIdAndSessionDateAndBusinessTypeAndCourtSession(
            String courtRoomId, LocalDate sessionDate, String businessType, String courtSession);
