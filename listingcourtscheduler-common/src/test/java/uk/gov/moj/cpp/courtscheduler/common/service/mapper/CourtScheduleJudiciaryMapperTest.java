...
class CourtScheduleJudiciaryMapperTest {
    ...
    void shouldMapNullableRotaProfileAndPositionBetweenDomainAndEntity() {
        ...
        final CourtScheduleJudiciary domain = new CourtScheduleJudiciary()
                ...
                .deputy(false)
                .active(true)
                .createdOn(uk.gov.moj.cpp.courtscheduler.domain.utils.DateUtils.toOffsetDateTime(new Date()))
                .updatedOn(uk.gov.moj.cpp.courtscheduler.domain.utils.DateUtils.toOffsetDateTime(new Date()));
