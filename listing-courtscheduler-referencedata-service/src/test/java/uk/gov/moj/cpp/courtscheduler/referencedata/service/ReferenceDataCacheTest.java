...
class ReferenceDataCacheTest {
    ...
    void shouldReturnBusinessTypeFromCacheWhenCacheEnabled() {
        ...
        verify(cacheService).get(ReferenceDataCache.ROTA_BUSINESS_TYPE_CACHE_PREFIX + BUSINESS_TYPE_CODE);
    }
    ...
    void shouldReturnCourtRoomFromCacheWhenCacheEnabled() {
        ...
        verify(cacheService).get(ReferenceDataCache.ROTA_COURTROOM_CACHE_PREFIX + COURT_ROOM_ID);
    }
    ...
    private void setBusinessTypeCache() {
        when(cacheService.get(ReferenceDataCache.ROTA_BUSINESS_TYPE_CACHE_PREFIX + BUSINESS_TYPE_CODE)).thenReturn(" {\n" +
    ...
    private void setCourtRoomCache() {
        when(cacheService.get(ReferenceDataCache.ROTA_COURTROOM_CACHE_PREFIX + COURT_ROOM_ID)).thenReturn(" {\n" +
