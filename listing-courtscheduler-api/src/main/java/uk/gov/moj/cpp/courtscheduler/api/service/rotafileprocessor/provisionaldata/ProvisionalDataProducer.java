...
public class ProvisionalDataProducer {
    ...
    public List<CourtSchedule> produceProvisionalData(final LocalDate startDate, final LocalDate endDate, final int cyclesToPopulate, final String ouCodes, final ProvisionalSessionDateProvider provisionalSessionDateProvider) {
