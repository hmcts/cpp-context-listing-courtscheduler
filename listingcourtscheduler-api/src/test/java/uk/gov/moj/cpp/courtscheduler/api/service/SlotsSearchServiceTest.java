...
class SlotsSearchServiceTest {
    ...
    private CourtSchedule createCourtScheduleWithHearingTimes() {
        return new CourtSchedule()
                ...
                .active(true)
                .sessionStartTime(LocalTime.parse("10:00").atDate(LocalDate.of(2025, 3, 12)).atZone(ZoneId.of("UTC")).toOffsetDateTime())
                .sessionEndTime(LocalTime.parse("12:00").atDate(LocalDate.of(2025, 3, 12)).atZone(ZoneId.of("UTC")).toOffsetDateTime())
    ...
    private CourtSchedule courtSchedule(final List<CourtScheduleJudiciary> courtScheduleJudiciary) {
        return new CourtSchedule()
                ...
                .slotBased(false)
                .allDaySplit(false)
                .maxDurationForMorning(0)
                .maxDurationForAfternoon(0)
                .totalBooked(0)
                .availableDurationForMorning(0)
                .availableDurationForAfternoon(0)
                .totalBookedForMorning(0)
                .totalBookedForAfternoon(0)
                .sessionStartTime(LocalTime.parse("10:00").atDate(LocalDate.of(2020, 12, 1)).atZone(ZoneId.of("UTC")).toOffsetDateTime())
                .sessionEndTime(LocalTime.parse("13:00").atDate(LocalDate.of(2020, 12, 1)).atZone(ZoneId.of("UTC")).toOffsetDateTime())
                .nationalBreakTime(TimezoneUtils.calculateNationalBreakTime(LocalDate.of(2020, 12, 1)).toInstant().atOffset(java.time.ZoneOffset.UTC))
                .overbookingAllowed(true)
                .draft(false)
