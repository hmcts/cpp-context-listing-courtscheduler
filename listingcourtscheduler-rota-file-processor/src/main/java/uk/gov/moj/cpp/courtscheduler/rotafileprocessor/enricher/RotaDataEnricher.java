...
public class RotaDataEnricher {
    ...
    private CourtSchedule updateExistingCourtSchedule(final CourtSchedule courtSchedule,
        ...
        courtScheduleBuilder.courtSession(ALL_DAY)
                .sessionStartTime(toOffsetDateTime(DateUtils.combineDateAndTime(courtSchedule.getSessionDate(), resolvedStartTime)))
                .sessionEndTime(toOffsetDateTime(DateUtils.combineDateAndTime(courtSchedule.getSessionDate(), resolvedEndTime)));
