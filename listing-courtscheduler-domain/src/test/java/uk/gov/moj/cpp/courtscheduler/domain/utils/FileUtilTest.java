...
public class FileUtilTest {
    ...
    public void shouldGetLJASnapshotFileTimeStampAsOffsetDateTime() {
        final OffsetDateTime actual = FileUtil.getLJASnapshotFileTimeStampAsOffsetDateTime("lja_southessex_snapshot_20210122T120000Z.xml", Logger.getGlobal());
        assertThat(actual.toString(), is("2021-01-22T12:00Z"));
    }

    @Test
    public void shouldReturnsNullGetLJASnapshotFileTimeStampAsOffsetDateTime() {
        final OffsetDateTime actual = FileUtil.getLJASnapshotFileTimeStampAsOffsetDateTime("lja_southessex_snapshot_202101000Z.xml", Logger.getGlobal());
